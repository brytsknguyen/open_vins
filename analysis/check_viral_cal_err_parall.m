...
pred_est_fn        = [exp_path 'predict_odom.csv'];
...
% SLAM estimate
openvins_data = csvread(pred_est_fn, 1, 0);
t_h = (openvins_data(:, 1) - t0_ns)/1e9;
P_h =  openvins_data(:, 4:6);
Q_h =  quatnormalize(openvins_data(:, [10, 7:9]));
V_h =  openvins_data(:, 11:13);
